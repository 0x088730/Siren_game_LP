  ...
  return (
    <div className="relative font-skranji text-white">
      <div className="relative overflow-hidden h-[750px] md:w-full xl:h-screen flex justify-center">
        ...
        <LazyLoadImage src="assets/images/characters/character-1.png" effect="opacity" alt="" className="absolute left-0 bottom-[50px] w-1/2 sm:w-[40%]" />
        <LazyLoadImage src="assets/images/characters/character-2.png" effect="opacity" alt="" className="absolute -right-4 bottom-[50px] w-1/2 sm:w-[40%]" />
      </div>
      ...
      <div className="relative md:w-full h-[900px] sm:h-[900px] md:h-[1223px] xl:h-[1223px] flex flex-col justify-start items-center mt-[-9rem] sm:mt-[-21rem] md:mt-[-28rem] lg:mt-[-32rem] xl:mt-[-50rem] 2xl:mt-[-48rem]">
        <img src="assets/images/backgrounds/contact.png" className="background-position-center-absolute w-[1920px] h-[900px] md:h-[1223px] lg:h-[1300px] 2xl:w-full 2xl:h-full" />
        ...
        <img src="assets/images/rock9.png" alt="" className="absolute right-0 -bottom-4 w-1/2 h-[30%]" />
