    ...
    <div className="w-full pt-32 bg-[url('../../public/assets/images/footer/back.jpg')] bg-cover">
      <div className="relative w-[350px] h-[300px] lg:w-[772px] lg:h-[700px] bottom-0 mx-auto">
        ...
        <div className="flex justify-center px-10">
            <img src="assets/images/footer/discordBtn1.png" alt="" className="w-1/4 duration-500 -translate-y-8 cursor-pointer z-8 lg:-translate-y-14 hover:brightness-125"/>
            ...
            <img src="assets/images/footer/tgBtn1.png" alt="" className="w-1/4 duration-500 -translate-y-8 cursor-pointer z-8 lg:-translate-y-14 hover:brightness-125"/>
        </div>
        <div className="">
            <img src="assets/images/footer/playBtn1.png" alt="" className="w-1/2 mx-auto duration-500 cursor-pointer z-8 translate-y-44 lg:translate-y-72 hover:brightness-125"/>
