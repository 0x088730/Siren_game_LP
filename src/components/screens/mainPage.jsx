...
const MainPage = () => {
    ...
    return (
        <div className="relative overflow-hidden h-[750px] md:w-full xl:h-screen flex justify-center">
            ...
            <LazyLoadImage effect="black-and-white" draggable="false" src="assets/images/characters/character-1.gif" alt="" className="absolute left-0 bottom-[50px] w-[55%] sm:w-[40%]" />
            <LazyLoadImage effect="black-and-white" draggable="false" src="assets/images/characters/character-2.gif" alt="" className="absolute -right-4 bottom-[50px] w-[45%] sm:w-[33%]" />
        </div>
    );
}
