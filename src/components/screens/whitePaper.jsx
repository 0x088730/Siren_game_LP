...
const WhitePaper = (props) => {
    ...
    return (
        <div id={t("WhitePaper")} className={`relative md:w-full ${props.loadedImages.loaded === true ? "xl:h-[1202px]" : "h-0" } flex justify-center overflow-visible mt-[22rem] sm:mt-[17rem] md:mt-[16rem] lg:mt-[16rem] xl:mt-0`}>
            <LazyImage
