      ...
      <div className="flex-col h-full overflow-y-scroll space-y-2 flex lg:items-center">
        ...
        {!refLinkInfo ?
          <>
            ...
            <div className="translate-y-24 flex justify-center items-center w-10/12 lg:w-10/12 xl:w-9/12 2xl:w-8/12 min-w-[1024px] gap-x-16">
              <div className="w-[45%]">
              ...
              <div className="pt-2 text-[44px] text-left text-white font-animeace w-[55%]">
                ...
                <div className="text-[20px] bg-[#e7b52d] w-fit px-6 py-1 rounded-full cursor-pointer mt-4" onClick={() => setRefLinkInfo(true)}>GET REFERRAL LINK</div>
              </div>
            </div>
          </>
          :
